...
<div align="center">
  ...
  <h1><b>Dish Discovery - Group JS Capstone</b></h1>
...
- [📖 Dish Discovery - Group JS Capstone ](#about-project)
...
# 📖 Dish Discovery - Group JS Capstone <a name="about-project"></a>

**Dish Discovery** is a final milestone project for microverse student in JavaScript Module <br>
In this project we implement some of the functional we learn through the module : 
...
```sh
  cd dishdiscovery-capstone-microverse
  npm install
```
...
- GitHub: [@abdozayan12](https://github.com/abdozayan12)
- Twitter: [@zayan_abdo](https://twitter.com/zayan_abdo)
- LinkedIn: [abdo-zayan-39b073128](https://www.linkedin.com/in/abdo-zayan-39b073128/)
